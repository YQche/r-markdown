    ...
    <header class="sticky top-0 z-50 bg-[rgba(245,245,247,0.8)] backdrop-blur-xl">
        ...
        <router-link to="/" class="flex items-center gap-2.5 no-underline shrink-0">
          ...
          <span class="text-[17px] font-bold text-[#111] tracking-tight">R-Markdown</span>
                                                                ...
                                                                <nav class="nav-pill relative flex items-center rounded-full bg-black/5 px-1.5 py-1 ml-auto">
          <a href="javascript:void(0)" class="nav-link inline-flex items-center gap-1.5 rounded-2xl px-4 py-2 text-[14px] font-medium text-[#555] no-underline transition-colors hover:text-[#111] hover:bg-black/8" @click="scrollToFeatures">
          ...
          <a href="https://github.com/RobocopMao/r-markdown" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 rounded-2xl px-4 py-2 text-[14px] font-medium text-[#555] no-underline transition-colors hover:text-[#111] hover:bg-black/8">
