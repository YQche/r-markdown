...
<template>
    ...
    <header class="sticky top-0 z-50 bg-[rgba(245,245,247,0.8)] backdrop-blur-xl">
        ...
        <router-link to="/" class="flex items-center gap-2.5 no-underline shrink-0">
          ...
          <a href="https://github.com/RobocopMao/r-markdown" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 rounded-2xl px-4 py-2 text-[14px] font-medium text-[#555] no-underline transition-colors hover:text-[#111]">
