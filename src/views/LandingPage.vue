    ...
    <header class="sticky top-0 z-50 bg-[rgba(245,245,247,0.8)] backdrop-blur-xl">
        ...
        <router-link to="/" class="flex items-center gap-2.5 no-underline shrink-0">
          ...
          <span class="text-[17px] font-bold text-[#111] tracking-tight">R-Markdown</span>
                        ...
                        <nav class="nav-pill relative flex items-center rounded-full bg-black/5 px-1 py-1 ml-auto mr-3">
          <a href="javascript:void(0)" class="nav-link inline-flex items-center gap-1.5 rounded-2xl px-4 py-2 text-[14px] font-medium text-[#555] no-underline transition-colors hover:text-[#111]" @click="scrollToFeatures">
        ...
        <a href="https://github.com/RobocopMao/r-markdown" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 rounded-full bg-black/5 px-3.5 py-2 text-[14px] font-medium text-[#555] no-underline transition-colors hover:text-[#111] hover:bg-black/8 shrink-0">
          <svg viewBox="0 0 20 20" width="18" height="18" fill="currentColor"><path d="M10 0C4.477 0 0 4.477 0 10c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.604-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0110 4.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C17.137 18.167 20 14.418 20 10c0-5.523-4.477-10-10-10z"/></svg>
          GitHub
        </a>
      </div>
    </header>
