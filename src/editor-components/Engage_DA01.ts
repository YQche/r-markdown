...
export const Engage_DA01 = {
  ...
  render(attrs: Record<string, string>, _body: string, t: ThemeColors): string {
    let html = `<section style="margin:48px 0px 28px;width:677px;max-width:100%;box-sizing:border-box;overflow:hidden;text-align:center;padding:24px;border-radius:14px;background:rgba(${t.rgb},0.05);border:1px dashed rgba(229,231,235,0.9)">`
    if (attrs.title)
