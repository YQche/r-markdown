...
const S = {
  ...
  statLabel:'margin:0px 0px 8px;font-size:10px;line-height:1.2;'
  ...
  numText: 'font-size:30px;line-height:64px;color:rgb(255,255,255);'
         + 'font-weight:900;letter-spacing:-1px',
  charCount:'margin:8px 0px 0px;font-size:10px;color:rgb(148,163,184);'
