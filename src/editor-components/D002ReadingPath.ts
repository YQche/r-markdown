...
const S = {
  ...
  label:    'margin:0px;padding:0px 0px 6px;font-size:10px;color:rgb(100,116,139);'
  ...
  track:    'padding:14px 12px 12px;border:1px solid rgb(229,231,235);border-radius:13px;'
  ...
  line:     'display:inline-block;vertical-align:middle;width:32px;height:1px;'
