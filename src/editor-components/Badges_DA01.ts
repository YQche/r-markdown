  ...
  attrs: [
    {
      ...
      description: '预设风格色调：accent（主题色）/ green（绿色）/ yellow（黄色）/ dark（深色）',
    },
    {
      key: 'color',
      label: '文字颜色',
      required: false,
      default: '',
      description: '自定义文字颜色，填入 CSS 颜色值如 #333，使用颜色单词或十六进制颜色值',
    },
    {
      key: 'bg',
      label: '背景颜色',
      required: false,
      default: '',
      description: '自定义背景颜色，填入 CSS 颜色值如 #f0f0f0，使用颜色单词或十六进制颜色值',
    },
  ],
