...
export function renderFrontMatter(meta, fullText, t) {
...
export function parseSteps(lines, start, t) {
  let i = start
...
export function parseBadges(lines, start, t) {
  let i = start
  const attrs = parseAttrs(lines[i])
  i++
  let text = ''
...
export function parseCtaBlock(lines, start, t) {
  let i = start
  const attrs = parseAttrs(lines[i])
  i++
...
export function parseBreaking(lines, start, t) {
  let i = start
...
export function parseCtaInline(lines, start, t) {
...
export function parseCompare(lines, start, t) {
  let i = start
  const attrs = parseAttrs(lines[i])
  i++
  let leftContent = '',
...
export function parseCallout(lines, start, t) {
  let i = start
...
export function parseEngage(lines, start, t) {
  const attrs = parseAttrs(lines[start])
...
export function parseGallery(lines, start) {
  let i = start
  const imgs = []
  const re = /!\[([^\]]*)\]\(([^)]+)\)/g
  let m
