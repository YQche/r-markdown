...
<img src="https://robocopmao.github.io/r-markdown/banner4.webp" width="100%" height="auto" radius="8px" fit="cover" position="center" />

> 使用HTML的img标签添加的扩展图片组件，可以设置图片宽高、圆角和对象适应模式。
